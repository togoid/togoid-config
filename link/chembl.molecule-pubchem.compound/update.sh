...
SELECT (replace(str(?molecule), "http://rdf.ebi.ac.uk/resource/chembl/molecule/", "") as ?chembl_id) (replace(str(?pubchem), "http://pubchem.ncbi.nlm.nih.gov/compound/", "") as ?pubchem_compound_id) 
WHERE{
