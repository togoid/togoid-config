...
```
% gzip -dc human.*.rna.gbff.gz | ./parse_refseq_rna_gbff.pl --mim
NM_001368885.1  120350
NM_001368886.1  120350
NR_158981.1 609238
NR_148048.2 605301
NR_148047.2 605301
NR_148053.2 605301
NM_001374457.1  603254
NR_148052.2 605301
NR_104272.2 615187
NR_137288.2 612494
[...]
...
* すでにアップされている config.yaml では `namespace: omim` `prefix: http://identifiers.org/omim/` となっているものが多いようですが、 `namespace: mim` `prefix: http://identifiers.org/mim/` でなくて大丈夫でしょうか。
* ディレクトリ名 `refseq.rna-mim` は `refseq.rna-omim` とすべきでしょうか。
* 対応する mim が存在しない場合はそのエントリ自体を pair.tsv に出力していないが、それでよいか。
