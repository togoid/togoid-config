...
SELECT  (replace(str(?instruct), "http://purl.jp/10/instruct/", "") as ?instruct_id)   (replace(str(?pubmed), "http://identifiers.org/pubmed/", "") as ?pubmed_id)
